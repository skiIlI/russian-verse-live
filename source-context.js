...
const SOURCE_FILES = [
  ...
  "scripts/youtube-captions.mjs",
  "scripts/youtube-audio.mjs",
  "scripts/youtube-audio-cache.mjs",
  "scripts/extract-audio-clip.py",
  "scripts/setup-benchmark-tools.ps1",
  "scripts/run-local-model-benchmark.py",
  "scripts/analyze-model-benchmark.mjs",
  "scripts/audit-youtube-services.mjs",
  "data/README.md",
  ...
  "tests/youtube-benchmark-ground-truth.test.mjs",
  "tests/youtube-review.test.mjs",
  "tests/youtube-captions.test.mjs",
  "tests/youtube-audio.test.mjs",
  "tests/youtube-audio-cache.test.mjs",
  "tests/transcript-review.test.mjs",
  "tests/transcript-timeline.test.mjs",
  "tests/whisper-session.test.mjs",
  "tests/transcription-benchmark.test.mjs",
  "tests/fixtures/august-16-2026-ground-truth.json",
  "tests/fixtures/youtube-benchmark-ground-truth.json",
