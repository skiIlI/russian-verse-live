...
assert.match(app, /parser\.js\?v=12/);
...
assert.equal(manifest.start_url, "./?v=12");
assert.match(worker, /verse-listener-v12/);
assert.match(worker, /audio-worklet\.js\?v=12/);
assert.match(worker, /feedback-api\.js\?v=12/);
assert.match(worker, /feedback-ui\.js\?v=12/);
assert.match(worker, /more-menu\.js\?v=12/);
assert.match(worker, /mic-level-meter\.js\?v=12/);
assert.match(worker, /mic-recording\.js\?v=12/);
assert.match(worker, /mic-test\.js\?v=12/);
assert.match(worker, /interpreter\.js\?v=12/);
assert.match(worker, /transcript-lab\.js\?v=12/);
assert.match(worker, /youtube-review\.js\?v=12/);
assert.match(worker, /transcript-feedback\.js\?v=12/);
assert.match(worker, /transcript-review\.js\?v=12/);
assert.match(worker, /transcript-timeline\.js\?v=12/);
assert.match(worker, /transcription-benchmark\.js\?v=12/);
assert.match(worker, /youtube-audio-transcriber\.js\?v=12/);
assert.match(worker, /whisper-session\.js\?v=12/);
assert.match(worker, /whisper-worker\.js\?v=12/);
